pipeline {
  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        ansiblePlaybook(playbook: 'cis-mikk.yml', credentialsId: '36d25621-624c-4d97-a1e4-aac84f6fe071', vaultCredentialsId: '6b976b74-3e55-436d-afd2-9b33d2d5ead7', tags: 'section5.2.2', becomeUser: 'mikk', colorized: true)
      }
    }
  }
}